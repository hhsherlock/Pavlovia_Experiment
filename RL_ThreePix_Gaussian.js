...
var fractal_top_middle;
var fractal_top_right;
var fractal_bottom_left;
var fractal_bottom_middle;
var fractal_bottom_right;
...
function size_adjustment(size) {
    if (window_size(size) > 0.56) {
        fractal_size = 0.3;
        fractal_pos = 0.5 * window_size(size);
    } else if (window_size(size) > 0.45) {
        fractal_size = window_size(size) * 0.45;
        fractal_pos = 0.5 * window_size(size) / (0.25 + window_size(size));
    } else {
        fractal_size = window_size(size) * 0.55;
        fractal_pos = 0.5 * window_size(size) / (0.25 + window_size(size));
    }

    return fractal_pos, fractal_size
}

function size_adjustment_two(size) {
    if (window_size(size) > 0.56) {
        fractal_size = 0.45;
        fractal_pos = 0.45 * window_size(size);
    } else if (window_size(size) > 0.45) {
        fractal_size = window_size(size) * 0.8;
        fractal_pos = 0.45 * window_size(size) / (0.35 + window_size(size));
    } else {
        fractal_size = window_size(size);
        fractal_pos = 0.45 * window_size(size) / (0.3 + window_size(size));
    }

    return fractal_pos, fractal_size
}

// copied from https://stackoverflow.com/questions/25582882/javascript-math-random-normal-distribution-gaussian-bell-curve
...
async function experimentInit() {
    ...
    practice_fractal_l = new visual.ImageStim({
        ...
        ori: 0.0, pos: [(- 0.35), (- 0.20)], size: [0.25, 0.25],
    ...
    practice_fractal_r = new visual.ImageStim({
        ...
        ori: 0.0, pos: [0.0, (- 0.20)], size: [0.25, 0.25],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false, wrapWidth: 1.0,
    ...
    instr_context1 = new visual.TextStim({
        ...
        font: font_style,
        units: undefined,
        pos: [0, 0.4125], height: 0.075, wrapWidth: 0.8, ori: 0.0,
        color: new util.Color('black'), opacity: undefined,
        depth: -4.0
    });
    ...
    continue_context1 = new visual.TextStim({
        ...
        font: font_style,
        units: undefined,
        pos: [0, (- 0.4)], height: 0.05, wrapWidth: 0.8, ori: 0.0,
        color: new util.Color('black'), opacity: undefined,
        depth: -2.0
    });
    ...
    practice_fractal_m_2 = new visual.ImageStim({
        win: psychoJS.window,
        name: 'practice_fractal_m_2', units: undefined,
        image: 'practice_main_B', mask: undefined,
        ori: 0.0, pos: [0.25, (- 0.04)], size: [0.325, 0.325],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    intro_7 = new visual.TextStim({
        win: psychoJS.window,
        name: 'intro_7',
        text: 'You will complete many trials with each combination of shapes. That is, you will choose among the same shapes many times. Sometimes a shape leads to a better value than its average and sometimes leads to a lower one. You must learn which shapes to choose to gain the maximum poitns through trial and error.',
        font: font_style,
        units: undefined,
        pos: [0, 0], height: 1.0, wrapWidth: undefined, ori: 0.0,
        color: new util.Color('black'), opacity: undefined,
    ...
    intro_16 = new visual.TextStim({
        win: psychoJS.window,
        name: 'intro_16',
        text: 'In detail, the value of every shape fluctuates around a unique value. For example, one shape may have an average value of 50 points, while another shape may have an average value of only 30 points. You must learn which shapes are better by paying attention to the outcomes. ',
        font: font_style,
        units: undefined,
        pos: [0, 0], height: 1.0, wrapWidth: undefined, ori: 0.0,
        color: new util.Color('black'), opacity: undefined,
    ...
    fractal_c_dec_pm = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_c_dec_pm', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.45, 0.45],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    outline_fc_4 = new visual.Rect({
        win: psychoJS.window, name: 'outline_fc_4',
        width: [0.5, 0.5][0], height: [0.5, 0.5][1],
        ori: 0.0, pos: [0, 0],
        lineWidth: 1.0, lineColor: new util.Color('lightblue'),
        fillColor: new util.Color('lightblue'),
    ...
    fractal_c_slctd_3 = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_c_slctd_3', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.45, 0.45],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    outline_fc_5 = new visual.Rect({
        win: psychoJS.window, name: 'outline_fc_5',
        width: [0.5, 0.5][0], height: [0.5, 0.5][1],
        ori: 0.0, pos: [0, 0],
        lineWidth: 1.0, lineColor: new util.Color('lightblue'),
        fillColor: new util.Color('lightblue'),
    ...
    fractal_c_fdbk_2 = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_c_fdbk_2', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.45, 0.45],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    outcome_amount_c_2 = new visual.TextStim({
        win: psychoJS.window,
        name: 'outcome_amount_c_2',
        text: '',
        font: font_style,
        units: undefined,
        pos: [0, 0], height: 0.1, wrapWidth: undefined, ori: 0.0,
    ...
    fractal_top_middle = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_top_middle', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.2, 0.2],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    fractal_bottom_left = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_bottom_left', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.2, 0.2],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    fractal_bottom_middle = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_bottom_middle', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.2, 0.2],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    fractal_bottom_right = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_bottom_right', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.2, 0.2],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    fractal_c_dec = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_c_dec', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.45, 0.45],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    outline_fc = new visual.Rect({
        win: psychoJS.window, name: 'outline_fc',
        width: [0.5, 0.5][0], height: [0.5, 0.5][1],
        ori: 0.0, pos: [0, 0],
        lineWidth: 1.0, lineColor: new util.Color('lightblue'),
        fillColor: new util.Color('lightblue'),
    ...
    fractal_c_slctd = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_c_slctd', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.45, 0.45],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    outline_fc_2 = new visual.Rect({
        win: psychoJS.window, name: 'outline_fc_2',
        width: [0.5, 0.5][0], height: [0.5, 0.5][1],
        ori: 0.0, pos: [0, 0],
        lineWidth: 1.0, lineColor: new util.Color('lightblue'),
        fillColor: new util.Color('lightblue'),
    ...
    fractal_c_fdbk = new visual.ImageStim({
        win: psychoJS.window,
        name: 'fractal_c_fdbk', units: undefined,
        image: undefined, mask: undefined,
        ori: 0.0, pos: [0, 0], size: [0.45, 0.45],
        color: new util.Color([1, 1, 1]), opacity: undefined,
        flipHoriz: false, flipVert: false,
    ...
    outcome_amount_c = new visual.TextStim({
        win: psychoJS.window,
        name: 'outcome_amount_c',
        text: '',
        font: font_style,
        units: undefined,
        pos: [0, 0], height: 0.1, wrapWidth: undefined, ori: 0.0,
...
function Instructions1ContextRoutineBegin(snapshot) {
    return async function () {
        ...
        fractal_pos, fractal_size = size_adjustment(psychoJS.window.size);
        ...
        instruction_context_fractal_l.setImage('practice_main_A');
        instruction_context_fractal_m.setImage('practice_main_B');
        instruction_context_fractal_r.setImage('practice_main_C');
        instruction_context_fractal_l.setPos([-fractal_pos, 0.05]);
        instruction_context_fractal_m.setPos([0, 0.05]);
        instruction_context_fractal_r.setPos([fractal_pos, 0.05]);
        instruction_context_fractal_l.setSize([fractal_size, fractal_size]);
        ...
        InstructionsContext1Components.push(instruction_context_fractal_m);
...
function Instructions1ContextRoutineEachFrame() {
    return async function () {
        ...
        // *instruction_context_fractal_m* updates
        if (t >= 0.0 && instruction_context_fractal_m.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            instruction_context_fractal_m.tStart = t;  // (not accounting for frame time here)
            instruction_context_fractal_m.frameNStart = frameN;  // exact frame index

            instruction_context_fractal_m.setAutoDraw(true);
        }
...
function Instructions2ContextRoutineBegin(snapshot) {
    return async function () {
        ...
        instruction_context_fractal_l.setImage('practice_once_D');
        instruction_context_fractal_m.setImage('practice_once_E');
        instruction_context_fractal_r.setImage('practice_once_F');
        instruction_context_fractal_l.setPos([-fractal_pos, 0.05]);
        instruction_context_fractal_m.setPos([0, 0.05]);
        instruction_context_fractal_r.setPos([fractal_pos, 0.05]);
        instruction_context_fractal_l.setSize([fractal_size, fractal_size]);
        ...
        InstructionsContext2Components.push(instruction_context_fractal_m);
...
function Instructions2RoutineBegin(snapshot) {
    return async function () {
        ...
        instruction_context_fractal_m.setImage('practice_main_B');
        instruction_context_fractal_r.setImage('practice_main_C');
        instruction_context_fractal_l.setPos([-fractal_pos, -0.1]);
        instruction_context_fractal_m.setPos([0, -0.1]);
        instruction_context_fractal_r.setPos([fractal_pos, -0.1]);
        instruction_context_fractal_l.setSize([fractal_size, fractal_size]);
        instruction_context_fractal_m.setSize([fractal_size, fractal_size]);
        instruction_context_fractal_r.setSize([fractal_size, fractal_size]);
        ...
        Instructions2Components.push(instruction_context_fractal_l);
        Instructions2Components.push(instruction_context_fractal_m);
        Instructions2Components.push(instruction_context_fractal_r);
...
function Instructions3RoutineBegin(snapshot) {
    return async function () {
        ...
        outline_pl.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
        outline_pl.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
        outline_pl.setPos([-fractal_pos, -0.1]);
        practice_fractal_l_2.setSize(fractal_size);
        practice_fractal_l_2.setPos([-fractal_pos, -0.1]);
        practice_fractal_m_2.setSize(fractal_size);
        practice_fractal_m_2.setPos([0, -0.1]);
        practice_fractal_r_2.setSize(fractal_size);
        practice_fractal_r_2.setPos([fractal_pos, -0.1]);
        practice_left_feed.setText(practice_left_feed_text);
        practice_left_feed.setPos([-fractal_pos, -0.32])
        ...
        Instructions3Components.push(practice_fractal_m_2);
...
function Instructions3RoutineEachFrame() {
    return async function () {
        ...
        // *practice_fractal_m_2* updates
        if (t >= 0.0 && practice_fractal_m_2.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            practice_fractal_m_2.tStart = t;  // (not accounting for frame time here)
            practice_fractal_m_2.frameNStart = frameN;  // exact frame index

            practice_fractal_m_2.setAutoDraw(true);
        }
...
function decision_pracRoutineBegin(snapshot) {
    return async function () {
        ...
        fractal_position = Math.floor(Math.random() * 6);
        y_fa = .05;
        y_fb = .05;
        y_fc = .05;
        if (fractal_position == 0) {
            x_fa = -fractal_pos;
            x_fb = 0;
            x_fc = fractal_pos;
        } else if (fractal_position == 1) {
            x_fa = -fractal_pos;
            x_fc = 0;
            x_fb = fractal_pos;
        } else if (fractal_position == 2) {
            x_fb = -fractal_pos;
            x_fa = 0;
            x_fc = fractal_pos;
        } else if (fractal_position == 3) {
            x_fb = -fractal_pos;
            x_fc = 0;
            x_fa = fractal_pos;
        } else if (fractal_position == 4) {
            x_fc = -fractal_pos;
            x_fa = 0;
            x_fb = fractal_pos;
        } else if (fractal_position == 5) {
            x_fc = -fractal_pos;
            x_fb = 0;
            x_fa = fractal_pos;
        }
        ...
        fractal_a_dec_pl.setImage('practice_main_A');
        fractal_a_dec_pl.setSize([fractal_size, fractal_size]);
        fractal_b_dec_pr.setPos([x_fb, y_fb]);
        fractal_b_dec_pr.setImage('practice_main_B');
        fractal_b_dec_pr.setSize([fractal_size, fractal_size]);
        fractal_c_dec_pm.setPos([x_fc, y_fc]);
        fractal_c_dec_pm.setImage('practice_main_C');
        fractal_c_dec_pm.setSize([fractal_size, fractal_size]);
        // set context
        ...
        decision_pracComponents.push(fractal_c_dec_pm);
...
function decision_pracRoutineEachFrame() {
    return async function () {
        ...
        if (fractal_a_dec_pl.contains(mouse) && mouse.getPressed()[0] === 1) {
            ...
            fa_click = 1;
        } else if (fractal_b_dec_pr.contains(mouse) && mouse.getPressed()[0] === 1) {
            psychoJS.experiment.addData("mouse.rt", decision_pracClock.getTime());
            psychoJS.experiment.addData("dec_prac_noprobe_choicetime", globalClock.getTime());
            fb_click = 1;
        } else if (fractal_c_dec_pm.contains(mouse) && mouse.getPressed()[0] === 1) {
            psychoJS.experiment.addData("mouse.rt", decision_pracClock.getTime());
            psychoJS.experiment.addData("dec_prac_noprobe_choicetime", globalClock.getTime());
            fc_click = 1;
        }
        ...
        if (mouse.status === PsychoJS.Status.STARTED) {  // only update if started and not finished!
            ...
            if (!_mouseButtons.every((e, i, ) => (e == prevButtonState[i]))) { // button state changed?
                ...
                if (_mouseButtons.reduce((e, acc) => (e + acc)) > 0) { // state changed to a new click
                    ...
                    gotValidClick = false;
                    for (const obj of [fractal_a_dec_pl, fractal_b_dec_pr, fractal_c_dec_pm]) {
        ...
        // *fractal_c_dec_pm* updates
        if (t >= 0.0 && fractal_c_dec_pm.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            fractal_c_dec_pm.tStart = t;  // (not accounting for frame time here)
            fractal_c_dec_pm.frameNStart = frameN;  // exact frame index

            fractal_c_dec_pm.setAutoDraw(true);
        }

        frameRemains = 0.0 + 2.5 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
        if (fractal_c_dec_pm.status === PsychoJS.Status.STARTED && t >= frameRemains) {
            fractal_c_dec_pm.setAutoDraw(false);
        }
        ...
        if (((fa_click === 0) && (fb_click === 0) && (fc_click === 0))) {
            ...
            if (fa_click) {
                ...
                if (fb_click) {
                    ...
                    chosen_outcome_train = outcome_c_train;
                }
            }
            ...
            psychoJS.experiment.addData("outcome_c_train", outcome_c_train);
        }
...
function selected_pracRoutineBegin(snapshot) {
    return async function () {
        ...
        outline_fa_4.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
        outline_fa_4.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
        outline_fb_4.setOpacity(fb_click);
        outline_fb_4.setPos([x_fb, y_fb]);
        outline_fb_4.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
        outline_fb_4.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
        outline_fc_4.setOpacity(fc_click);
        outline_fc_4.setPos([x_fc, y_fc]);
        outline_fc_4.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
        outline_fc_4.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);

        fractal_a_slctd_3.setPos([x_fa, y_fa]);
        fractal_a_slctd_3.setImage('practice_main_A');
        fractal_a_slctd_3.setSize(fractal_size);
        fractal_b_slctd_3.setPos([x_fb, y_fb]);
        fractal_b_slctd_3.setImage('practice_main_B');
        fractal_b_slctd_3.setSize(fractal_size);
        fractal_c_slctd_3.setPos([x_fc, y_fc]);
        fractal_c_slctd_3.setImage('practice_main_C');
        fractal_c_slctd_3.setSize(fractal_size);
        // set context
        background_color_practice.setWidth(2);
        background_color_practice.setHeight(2);
        background_color_practice.setFillColor([0.84706, 0.52941, 0.00000]);
...
function selected_pracRoutineEachFrame() {
    return async function () {
        ...
        // *outline_fc_4* updates
        if (t >= 0.0 && outline_fc_4.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            outline_fc_4.tStart = t;  // (not accounting for frame time here)
            outline_fc_4.frameNStart = frameN;  // exact frame index

            outline_fc_4.setAutoDraw(true);
        }

        frameRemains = 0.0 + 1.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
        if (outline_fc_4.status === PsychoJS.Status.STARTED && t >= frameRemains) {
            outline_fc_4.setAutoDraw(false);
        }
        ...
        // *fractal_c_slctd_3* updates
        if (t >= 0.0 && fractal_c_slctd_3.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            fractal_c_slctd_3.tStart = t;  // (not accounting for frame time here)
            fractal_c_slctd_3.frameNStart = frameN;  // exact frame index

            fractal_c_slctd_3.setAutoDraw(true);
        }

        frameRemains = 0.0 + 1.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
        if (fractal_c_slctd_3.status === PsychoJS.Status.STARTED && t >= frameRemains) {
            fractal_c_slctd_3.setAutoDraw(false);
        }
        // check for quit (typically the Esc key)
        if (psychoJS.experiment.experimentEnded || psychoJS.eventManager.getKeys({ keyList: ['escape'] }).length > 0) {
            return quitPsychoJS('The [Escape] key was pressed. Goodbye!', false);
...
function feedback_pracRoutineBegin(snapshot) {
    return async function () {
        ...
        outcome_txt_c = outcome_c_train.toString();
        sign_c = "+";
        color_c = "black";
        outcome_c_string = (sign_c + outcome_txt_c);

        outline_fa_5.setOpacity(fa_click);
        outline_fa_5.setPos([x_fa, y_fa]);
        outline_fa_5.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
        outline_fa_5.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
        outline_fb_5.setOpacity(fb_click);
        outline_fb_5.setPos([x_fb, y_fb]);
        outline_fb_5.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
        outline_fb_5.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
        outline_fc_5.setOpacity(fc_click);
        outline_fc_5.setPos([x_fc, y_fc]);
        outline_fc_5.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
        outline_fc_5.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
        fractal_a_fdbk_2.setPos([x_fa, y_fa]);
        fractal_a_fdbk_2.setImage('practice_main_A');
        fractal_a_fdbk_2.setSize(fractal_size);
        fractal_b_fdbk_2.setPos([x_fb, y_fb]);
        fractal_b_fdbk_2.setImage('practice_main_B');
        fractal_b_fdbk_2.setSize(fractal_size);
        fractal_c_fdbk_2.setPos([x_fc, y_fc]);
        fractal_c_fdbk_2.setImage('practice_main_C');
        fractal_c_fdbk_2.setSize(fractal_size);
        ...
        outcome_amount_c_2.setColor(new util.Color(color_c));
        outcome_amount_c_2.setPos([x_fc, y_outcome_text]);
        outcome_amount_c_2.setText(outcome_c_string);
        outcome_amount_c_2.setOpacity(fc_click);
        // set context
        background_color_practice.setWidth(2);
        background_color_practice.setHeight(2);
        background_color_practice.setFillColor([0.84706, 0.52941, 0.00000]);
...
function feedback_pracRoutineEachFrame() {
    return async function () {
        ...
        // *outline_fc_5* updates
        if (t >= 0.0 && outline_fc_5.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            outline_fc_5.tStart = t;  // (not accounting for frame time here)
            outline_fc_5.frameNStart = frameN;  // exact frame index

            outline_fc_5.setAutoDraw(true);
        }

        frameRemains = 0.0 + feed_dur - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
        if (outline_fc_5.status === PsychoJS.Status.STARTED && t >= frameRemains) {
            outline_fc_5.setAutoDraw(false);
        }
        ...
        // *fractal_c_fdbk_2* updates
        if (t >= 0.0 && fractal_c_fdbk_2.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            fractal_c_fdbk_2.tStart = t;  // (not accounting for frame time here)
            fractal_c_fdbk_2.frameNStart = frameN;  // exact frame index

            fractal_c_fdbk_2.setAutoDraw(true);
        }

        frameRemains = 0.0 + feed_dur - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
        if (fractal_c_fdbk_2.status === PsychoJS.Status.STARTED && t >= frameRemains) {
            fractal_c_fdbk_2.setAutoDraw(false);
        }
        ...
        // *outcome_amount_c_2* updates
        if (t >= 0.0 && outcome_amount_c_2.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            outcome_amount_c_2.tStart = t;  // (not accounting for frame time here)
            outcome_amount_c_2.frameNStart = frameN;  // exact frame index

            outcome_amount_c_2.setAutoDraw(true);
        }

        frameRemains = 0.0 + feed_dur - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
        if (outcome_amount_c_2.status === PsychoJS.Status.STARTED && t >= frameRemains) {
            outcome_amount_c_2.setAutoDraw(false);
        }
...
function block_primer_1RoutineBegin(snapshot) {
    return async function () {
        ...
        fractal_mb = 'pair2_E';
        fractal_mc = 'pair2_F';
        first_combination = [fractal_ta, fractal_tb, fractal_tc];
        second_combination = [fractal_ma, fractal_mb, fractal_mc];
        if ((blocks_run === 0)) {
            primer_txt = "The experiment will now begin. You will make choices among these shapes.";
        } else {
            if ((blocks_run === 1)) {
        ...
        psychoJS.experiment.addData("TMPfractal_tc", fractal_tc);
        psychoJS.experiment.addData("TMPfractal_ma", fractal_ma);
        psychoJS.experiment.addData("TMPfractal_mb", fractal_mb);
        psychoJS.experiment.addData("TMPfractal_mc", fractal_mc);
        primer_text.setText(primer_txt);
        primer_next_1.keys = undefined;
        primer_next_1.rt = undefined;
        _primer_next_1_allKeys = [];
        if (blocks_run === 0) {
            fractal_top_left.setPos([-0.3, 0.15]);
            fractal_top_left.setImage(fractal_ta);
            fractal_top_middle.setPos([0, 0.15]);
            fractal_top_middle.setImage(fractal_tb);
            fractal_top_right.setPos([0.3, 0.15]);
            fractal_top_right.setImage(fractal_tc);
            fractal_bottom_left.setPos([-0.3, (- 0.15)]);
            fractal_bottom_left.setImage(fractal_ma);
            fractal_bottom_middle.setPos([0, (- 0.15)]);
            fractal_bottom_middle.setImage(fractal_mb);
            fractal_bottom_right.setPos([0.3, (- 0.15)]);
            fractal_bottom_right.setImage(fractal_mc);
        } else if (blocks_run === 1) {
            fractal_top_left.setPos([-0.15, 0.15]);
            fractal_top_left.setImage(fractal_ta);
            fractal_top_left.setSize(0.15);
            fractal_top_middle.setPos([-0.15, -0.05]);
            fractal_top_middle.setImage(fractal_tb);
            fractal_top_middle.setSize(0.15);
            fractal_top_right.setPos([-0.15, -0.25]);
            fractal_top_right.setImage(fractal_tc);
            fractal_top_right.setSize(0.15);
            fractal_bottom_left.setPos([0.15, 0.15]);
            fractal_bottom_left.setImage(fractal_ma);
            fractal_bottom_left.setSize(0.15);
            fractal_bottom_middle.setPos([0.15, -0.05]);
            fractal_bottom_middle.setImage(fractal_mb);
            fractal_bottom_middle.setSize(0.15);
            fractal_bottom_right.setPos([0.15, (- 0.25)]);
            fractal_bottom_right.setImage(fractal_mc);
            fractal_bottom_right.setSize(0.15);
        }
        ...
        block_primer_1Components.push(fractal_top_middle);
        block_primer_1Components.push(fractal_top_right);
        block_primer_1Components.push(fractal_bottom_left);
        block_primer_1Components.push(fractal_bottom_middle);
        block_primer_1Components.push(fractal_bottom_right);
...
function block_primer_1RoutineEachFrame() {
    return async function () {
        ...
        // *fractal_top_middle* updates
        if (t >= 0.0 && fractal_top_middle.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            fractal_top_middle.tStart = t;  // (not accounting for frame time here)
            fractal_top_middle.frameNStart = frameN;  // exact frame index

            fractal_top_middle.setAutoDraw(true);
        }
        ...
        // *fractal_bottom_left* updates
        if (t >= 0.0 && fractal_bottom_left.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            fractal_bottom_left.tStart = t;  // (not accounting for frame time here)
            fractal_bottom_left.frameNStart = frameN;  // exact frame index

            fractal_bottom_left.setAutoDraw(true);
        }

        // *fractal_bottom_middle* updates
        if (t >= 0.0 && fractal_bottom_middle.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            fractal_bottom_middle.tStart = t;  // (not accounting for frame time here)
            fractal_bottom_middle.frameNStart = frameN;  // exact frame index

            fractal_bottom_middle.setAutoDraw(true);
        }

        // *fractal_bottom_right* updates
        if (t >= 0.0 && fractal_bottom_right.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
            fractal_bottom_right.tStart = t;  // (not accounting for frame time here)
            fractal_bottom_right.frameNStart = frameN;  // exact frame index

            fractal_bottom_right.setAutoDraw(true);
        }
...
function decisionRoutineBegin(snapshot) {
    return async function () {
        ...
        if (blocks_run === 0) {
            ...
            fractal_pos, fractal_size = size_adjustment(psychoJS.window.size)
            var r_fractal_position = Math.floor(Math.random() * 6);
            y_fa = .05;
            y_fb = .05;
            y_fc = .05;
            if (r_fractal_position == 0) {
                x_fa = -fractal_pos;
                x_fb = 0;
                x_fc = fractal_pos;
            } else if (r_fractal_position == 1) {
                x_fa = -fractal_pos;
                x_fc = 0;
                x_fb = fractal_pos;
            } else if (r_fractal_position == 2) {
                x_fb = -fractal_pos;
                x_fa = 0;
                x_fc = fractal_pos;
            } else if (r_fractal_position == 3) {
                x_fb = -fractal_pos;
                x_fc = 0;
                x_fa = fractal_pos;
            } else if (r_fractal_position == 4) {
                x_fc = -fractal_pos;
                x_fa = 0;
                x_fb = fractal_pos;
            } else if (r_fractal_position == 5) {
                x_fc = -fractal_pos;
                x_fb = 0;
                x_fa = fractal_pos;
            }
            ...
            fractal_c_dec.setPos([x_fc, y_fc]);
        ...
        if (blocks_run === 0) {
            ...
            decisionComponents.push(fractal_c_dec);
        } else {
...
function decisionRoutineEachFrame() {
    return async function () {
        ...
        if (blocks_run === 0) {
            if (fractal_a_dec.contains(mouse_2) && mouse_2.getPressed()[0] === 1) {
                ...
                if (fractal_b_dec.contains(mouse_2) && mouse_2.getPressed()[0] === 1) {
                    ...
                    if (fractal_c_dec.contains(mouse_2) && mouse_2.getPressed()[0] === 1) {
                        psychoJS.experiment.addData("mouse_2.rt", decisionClock.getTime());
                        psychoJS.experiment.addData("dec_choicetime", globalClock.getTime());
                        fc_click = 1;
                    }
            ...
            if (mouse_2.status === PsychoJS.Status.STARTED) {  // only update if started and not finished!
                ...
                if (!_mouseButtons.every((e, i, ) => (e == prevButtonState[i]))) { // button state changed?
                    ...
                    if (_mouseButtons.reduce((e, acc) => (e + acc)) > 0) { // state changed to a new click
                        // check if the mouse was inside our 'clickable' objects
                        gotValidClick = false;
                        for (const obj of [fractal_a_dec, fractal_b_dec, fractal_c_dec]) {
        ...
        if (blocks_run === 0) {
            ...
            // *fractal_c_dec* updates
            if (t >= 0.0 && fractal_c_dec.status === PsychoJS.Status.NOT_STARTED) {
                // keep track of start time/frame for later
                fractal_c_dec.tStart = t;  // (not accounting for frame time here)
                fractal_c_dec.frameNStart = frameN;  // exact frame index

                fractal_c_dec.setAutoDraw(true);
            }

            frameRemains = 0.0 + 2.5 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
            if (fractal_c_dec.status === PsychoJS.Status.STARTED && t >= frameRemains) {
                fractal_c_dec.setAutoDraw(false);
            }
        } else {
    ...
    return async function () {
        ...
        if (blocks_run === 0) {
            ...
            if (((fa_click === 0) && (fb_click === 0) && (fc_click === 0))) {
                ...
                outcome_a = fractalA_R;
                outcome_b = fractalB_R;
                outcome_c = fractalC_R;
                if (fa_click) {
                ...
                psychoJS.experiment.addData("outcome_c", outcome_c);
                psychoJS.experiment.addData("chooseA", fa_click);
                psychoJS.experiment.addData("chooseB", fb_click);
                psychoJS.experiment.addData("chooseC", fc_click);
...
function selectedRoutineBegin(snapshot) {
    return async function () {
        ...
        // update component parameters for each repeat
        if (blocks_run === 0) {
            outline_fc.setOpacity(fc_click);
            outline_fc.setPos([x_fc, y_fc]);
            outline_fc.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
            outline_fc.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
            fractal_c_slctd.setPos([x_fc, y_fc]);
            fractal_c_slctd.setImage(fractalC);
            fractal_c_slctd.setSize([fractal_size, fractal_size]);
        }
        ...
        if (blocks_run === 0) {
            ...
            selectedComponents.push(outline_fc);
            selectedComponents.push(fractal_c_slctd);
        } else {
...
function selectedRoutineEachFrame() {
    return async function () {
        ...
        if (blocks_run === 0) {
            ...
            // *outline_fc* updates
            if (t >= 0.0 && outline_fc.status === PsychoJS.Status.NOT_STARTED) {
                // keep track of start time/frame for later
                outline_fc.tStart = t;  // (not accounting for frame time here)
                outline_fc.frameNStart = frameN;  // exact frame index

                outline_fc.setAutoDraw(true);
            }

            frameRemains = 0.0 + 1.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
            if (outline_fc.status === PsychoJS.Status.STARTED && t >= frameRemains) {
                outline_fc.setAutoDraw(false);
            }

            // *fractal_c_slctd* updates
            if (t >= 0.0 && fractal_c_slctd.status === PsychoJS.Status.NOT_STARTED) {
                // keep track of start time/frame for later
                fractal_c_slctd.tStart = t;  // (not accounting for frame time here)
                fractal_c_slctd.frameNStart = frameN;  // exact frame index

                fractal_c_slctd.setAutoDraw(true);
            }

            frameRemains = 0.0 + 1.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
            if (fractal_c_slctd.status === PsychoJS.Status.STARTED && t >= frameRemains) {
                fractal_c_slctd.setAutoDraw(false);
            }
        } else {
            // *background_color_right* updates
            if (t >= 0.0 && background_color_right.status === PsychoJS.Status.NOT_STARTED) {
...
function feedbackRoutineBegin(snapshot) {
    return async function () {
        ...
        outcome_a_string = ("+" + outcome_a.toString());
        outcome_b_string = ("+" + outcome_b.toString());

        outcome_amount_a.setColor(new util.Color(color_a));
        outcome_amount_a.setPos([x_fa, (-0.3) + y_fa]);
        ...
        outcome_amount_b.setPos([x_fb, (-0.3) + y_fb]);
        ...
        if (blocks_run === 0) {
            color_c = "black";
            outcome_c_string = ("+" + outcome_c.toString());
            outline_fc_2.setOpacity(fc_click);
            outline_fc_2.setPos([x_fc, y_fc]);
            outline_fc_2.setWidth([fractal_size + 0.05, fractal_size + 0.05][0]);
            outline_fc_2.setHeight([fractal_size + 0.05, fractal_size + 0.05][1]);
            fractal_c_fdbk.setPos([x_fc, y_fc]);
            fractal_c_fdbk.setImage(fractalC);
            fractal_c_fdbk.setSize([fractal_size, fractal_size]);
            outcome_amount_c.setColor(new util.Color(color_c));
            outcome_amount_c.setPos([x_fc, (-0.3) + y_fc]);
            outcome_amount_c.setOpacity(fc_click);
            outcome_amount_c.setText(outcome_c_string);
        ...
        if (blocks_run === 0) {
            ...
            feedbackComponents.push(outline_fc_2);
            feedbackComponents.push(fractal_c_fdbk);
            feedbackComponents.push(outcome_amount_c);
        } else {
...
function feedbackRoutineEachFrame() {
    return async function () {
        ...
        if (blocks_run === 0) {
            ...
            // *outline_fc_2* updates
            if (t >= 0.0 && outline_fc_2.status === PsychoJS.Status.NOT_STARTED) {
                // keep track of start time/frame for later
                outline_fc_2.tStart = t;  // (not accounting for frame time here)
                outline_fc_2.frameNStart = frameN;  // exact frame index

                outline_fc_2.setAutoDraw(true);
            }

            frameRemains = 0.0 + feed_dur - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
            if (outline_fc_2.status === PsychoJS.Status.STARTED && t >= frameRemains) {
                outline_fc_2.setAutoDraw(false);
            }

            // *fractal_c_fdbk* updates
            if (t >= 0.0 && fractal_c_fdbk.status === PsychoJS.Status.NOT_STARTED) {
                // keep track of start time/frame for later
                fractal_c_fdbk.tStart = t;  // (not accounting for frame time here)
                fractal_c_fdbk.frameNStart = frameN;  // exact frame index

                fractal_c_fdbk.setAutoDraw(true);
            }

            frameRemains = 0.0 + feed_dur - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
            if (fractal_c_fdbk.status === PsychoJS.Status.STARTED && t >= frameRemains) {
                fractal_c_fdbk.setAutoDraw(false);
            }

            // *outcome_amount_c* updates
            if (t >= 0.0 && outcome_amount_c.status === PsychoJS.Status.NOT_STARTED) {
                // keep track of start time/frame for later
                outcome_amount_c.tStart = t;  // (not accounting for frame time here)
                outcome_amount_c.frameNStart = frameN;  // exact frame index

                outcome_amount_c.setAutoDraw(true);
            }

            frameRemains = 0.0 + feed_dur - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
            if (outcome_amount_c.status === PsychoJS.Status.STARTED && t >= frameRemains) {
                outcome_amount_c.setAutoDraw(false);
            }
...
function pauseRoutineEachFrame() {
    return async function () {
        ...
        if (t >= 5 && continue_pause.status === PsychoJS.Status.NOT_STARTED) {
            // keep track of start time/frame for later
        ...
        minutes = Number.parseInt(((5 - time_left) / 60));
        seconds = Number.parseInt(((5 - time_left) - (minutes * 60)));
